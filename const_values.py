...
CLIENT_GREETING = '''
🤖 Привет! 
Я есть Бот, и меня создали для удобства клиентов сервиса Автосклад34🏪
Во мне заложены функции для отслеживания истории обслуживания (📷включая фотоотчет мастеров) и удобной записи на ремонт.
